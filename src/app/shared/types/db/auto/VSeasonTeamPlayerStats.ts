...
export class VSeasonTeamPlayerStats implements Table {
    ...
    fromDbValues(values: any): VSeasonTeamPlayerStats {
        ...
        newVSeasonTeamPlayerStats.id = values.id;
        newVSeasonTeamPlayerStats.season_id = values.season_id;
        newVSeasonTeamPlayerStats.team_id = values.team_id;
        newVSeasonTeamPlayerStats.player_id = values.player_id;
        newVSeasonTeamPlayerStats.games = values.games;
        newVSeasonTeamPlayerStats.minutes_played = values.minutes_played;
        newVSeasonTeamPlayerStats.field_goals = values.field_goals;
        newVSeasonTeamPlayerStats.field_goal_attempts = values.field_goal_attempts;
        newVSeasonTeamPlayerStats.field_goal_percentage = values.field_goal_percentage;
        newVSeasonTeamPlayerStats.three_point_field_goals = values.three_point_field_goals;
        newVSeasonTeamPlayerStats.three_point_field_goal_attemps = values.three_point_field_goal_attemps;
        newVSeasonTeamPlayerStats.three_point_field_goal_percentage = values.three_point_field_goal_percentage;
        newVSeasonTeamPlayerStats.two_point_field_goals = values.two_point_field_goals;
        newVSeasonTeamPlayerStats.two_point_field_goal_attempts = values.two_point_field_goal_attempts;
        newVSeasonTeamPlayerStats.two_point_field_goal_percentage = values.two_point_field_goal_percentage;
        newVSeasonTeamPlayerStats.effective_field_goal_percentage = values.effective_field_goal_percentage;
        newVSeasonTeamPlayerStats.free_throws = values.free_throws;
        newVSeasonTeamPlayerStats.free_throw_attempts = values.free_throw_attempts;
        newVSeasonTeamPlayerStats.free_throw_percentage = values.free_throw_percentage;
        newVSeasonTeamPlayerStats.offensive_rebounds = values.offensive_rebounds;
        newVSeasonTeamPlayerStats.difensive_rebounds = values.difensive_rebounds;
        newVSeasonTeamPlayerStats.total_rebounds = values.total_rebounds;
        newVSeasonTeamPlayerStats.assists = values.assists;
        newVSeasonTeamPlayerStats.steals = values.steals;
        newVSeasonTeamPlayerStats.blocks = values.blocks;
        newVSeasonTeamPlayerStats.turnovers = values.turnovers;
        newVSeasonTeamPlayerStats.personal_fouls = values.personal_fouls;
        newVSeasonTeamPlayerStats.points = values.points;
